...
ActiveRecord::Schema.define(version: 20171128082512) do
  ...
  create_table "library_categories", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
